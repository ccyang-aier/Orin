...
【批注，简单讲解下这个成本模型，每个字段表示啥，为什么这么算的】
...
【批注，这里 Orca 是指什么？如果是一个人的话，可以弱化它，只说明第一条演进路径的内容、设计等即可】
...
【批注，NanoFlow是什么？如果也是人名，弱化，如果不是，做一个前置的简单介绍】
【批注，这里说一堆内容内容太空泛，要具体展开下其思想和原理实现等】
...
【批注，废弃这张图，无太大价值，我建议是重新输出两张图，一张是阐述iteration-level scheduling思想和原理的，一章是阐述operation-level pipeline思想和原理的，分别放在第一和第三条线索下】
![异步调度的演进地图](imgs/06_evolution_map.png)

【批注，下面这个git演进历史没有展示的价值，你应该展示的每一个关键设计决策的原因和为什么这么设计等，而不是呈现一堆git历史】
