...
图 1 展示的是能力层级，而不是产品功能清单。单模型阶段解决“启动”，多副本阶段解决“承载更多请求”，Kubernetes 提供副本、调度、Service、滚动更新、HPA 等通用编排能力。AIBrix 关注的是围绕模型副本的部署、选择、弹性与治理：平台怎样根据 LLM Serving 的特征做请求选择、LLM 语义下的弹性治理、缓存协同和长期运营。
